...
export class IssueStore implements IIssueStore {
  ...
  addIssueToStore = (issue: TIssue) => {
    const issuePayload: TIssue = {
      ...
      design_estimate_points: issue?.design_estimate_points,
      dev_estimate_points: issue?.dev_estimate_points,
      qa_estimate_points: issue?.qa_estimate_points,
      ...
      qa_outcome: issue?.qa_outcome,
      pin_level: issue?.pin_level,
